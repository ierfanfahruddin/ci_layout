                            ...
                            <div class="card-tools">
                                <form action="" method="get">
                                    <div class="input-group input-group-sm" style="width: 150px;">
                                        <input type="text" value="<?= @$_GET['cari'] ?>" name="cari" class="form-control float-right" placeholder="Search">
                                    ...
                                    <?php foreach ($obat as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('apa anda yakin')" href="<?= $this->config->base_url('index.php/obat/delete/') . $row['id'] ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach;   ?>
                                </tbody>
